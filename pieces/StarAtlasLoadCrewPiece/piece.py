...
class StarAtlasUnloadCrewPiece(BasePiece):
    ...
    def init_piece(self):
        ...
        self.url_put_load_crew_fleet = self.read_secrets('URL_PUT_LOAD_CREW_FLEET')
    ...
    def piece_function(self, input_data: InputModel):
        ...
        if fleet_status == FleetStatusEnum.StarbaseLoadingBay:
            ...
            self.logger.info(f"Crew loaded successfully for {input_data.fleet_name} on ({input_data.destination_x}, {input_data.destination_y}), {input_data.amount}")
