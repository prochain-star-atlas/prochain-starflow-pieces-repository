...
class StarAtlasLoadCargoPiece(BasePiece):
    ...
    def __init__(self):
        ...
        self.url_put_load_cargo = os.environ['URL_PUT_LOAD_CARGO']
        self.url_put_load_ammo = os.environ['URL_PUT_LOAD_AMMO']
        self.url_put_load_fuel = os.environ['URL_PUT_LOAD_FUEL']
    ...
    def piece_function(self, input_data: InputModel):
        ...
        if input_data.resource_mint == "ammoK8AkX2wnebQb35cDAZtTkvsXQbi82cGeTnUvvfK":
            ...
            self.retry_put_request(url_formated_load_ammo, client_token_loggedin)
            ...
            self.retry_put_request(url_formated_load_fuel, client_token_loggedin)
        else:
            ...
            self.retry_put_request(url_formated_load_cargo, client_token_loggedin)
